// Duplicated from apps/ui/src/hooks/use-copy.ts -- pure (sonner + browser
// clipboard APIs only), needed by several migrated components (copy-button,
// copyable-code, key-chip, share-button).
...
export function shouldUseNavigatorClipboard(
